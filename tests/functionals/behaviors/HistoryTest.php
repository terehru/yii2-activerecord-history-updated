...
namespace terehru\activerecord\history\tests\functionals\behaviors;

use Yii;
use terehru\activerecord\history\tests\functionals\TestCase;
use terehru\activerecord\history\tests\functionals\assets\models\Post;
use terehru\activerecord\history\tests\functionals\assets\models\User;
use yii\db\Query;
use terehru\activerecord\history\behaviors\History;
...
class HistoryTest extends TestCase
{
    public function testInsertEventRecord()
    {
        ...
        $post->attachBehavior('arhistory', [
            'class' => 'terehru\activerecord\history\behaviors\History',
        ]);
